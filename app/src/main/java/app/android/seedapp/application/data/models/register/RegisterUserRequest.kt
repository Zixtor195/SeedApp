...
data class RegisterUserRequest(
    ...
    @SerializedName("type_document") val userTypeDocument: String = "CC",
    ...
    @SerializedName("is_leader") val userIsLeader: Boolean = false,
    @SerializedName("rel_id_municipality") val userMunicipality: Int = -1,
    //@SerializedName("rel_id_department") val userDepartment: Int = -1,
    @SerializedName("user_first_lv") val userLevel: Int = 0,
    @SerializedName("place") val userVotePlace: String = "",
    @SerializedName("address_user") val userAddress: String = "",
